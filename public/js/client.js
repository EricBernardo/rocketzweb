...
inputmask__WEBPACK_IMPORTED_MODULE_0___default()('99.999.999/9999-99', {
  "placeholder": ""
}).mask($('[name="cnpj"]'));
inputmask__WEBPACK_IMPORTED_MODULE_0___default()('(99) 9999-99999', {
  "placeholder": ""
}).mask($('[name="phone"]'));
inputmask__WEBPACK_IMPORTED_MODULE_0___default()('99999-999', {
  "placeholder": ""
}).mask($('[name="cep"]'));
$(document).ready(function () {
  ...
  $('select[name="state_id"]').change(function () {
    ...
    var data_text = el.attr('data-text');
  ...
  var state_id = $('select[name="state_id"]').attr('data-value');
